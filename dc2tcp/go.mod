module github.com/peergoim/tcp2p/dc2tcp

go 1.20

require (
	github.com/peergoim/signaling-client v0.0.0-00010101000000-000000000000
...
replace github.com/peergoim/signaling-client v0.0.0-00010101000000-000000000000 => ../../signaling-client
